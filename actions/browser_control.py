...
# Every negative-outcome prefix this module (dispatcher + internal Session
# methods, all reached only through this dispatcher) can return. Exact and
# authoritative — not a guess — same pattern as file_controller.py.
_ERROR_PREFIXES = (
