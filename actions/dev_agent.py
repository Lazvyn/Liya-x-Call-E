...
PROJECTS_DIR     = Path.home() / "Desktop" / "LiyaProjects"
MAX_FIX_ATTEMPTS = 5
MODEL_PLANNER    = MODEL_FLASH
MODEL_WRITER     = MODEL_FLASH
...
def _build_project(
    ...
    proj_name    = project_name or plan.get("project_name", "liya_project")
...
# Every negative-outcome prefix this module's top-level function can
# return. Exact and authoritative — not a guess — same pattern as
# file_controller.py.
_ERROR_PREFIXES = (
    "Please describe the project you want me to build",
    "Rate limit reached",
    "Planning failed:",
    "I could not write any project files",
    "I couldn't fully fix",
)
...
def dev_agent(
    ...
    if not description:
        return fail("Please describe the project you want me to build, sir.")
